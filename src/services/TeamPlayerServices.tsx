...
import { ServiceError, ServiceSuccess, ErrorData, ServiceSuccessInterface, ServiceErrorInterface } from "./Services";
...
export const getTeamPlayers: () => Promise<ServiceSuccessInterface<PlayerProps[]> | ServiceErrorInterface> = async () => {
  try {
